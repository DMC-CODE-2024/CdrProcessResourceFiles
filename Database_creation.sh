...
insert ignore into app.sys_param ( tag , value , feature_name) values ('CDR_IMEI_LENGTH_CHECK','True','CDR');
insert ignore into app.sys_param ( tag , value , feature_name) values ('CDR_IMEI_LENGTH_VALUE','14,15,16','CDR');
insert ignore into app.sys_param ( tag , value , feature_name) values ('CDR_NULL_IMEI_CHECK','True','CDR');
insert ignore into app.sys_param ( tag , value , feature_name) values ('CDR_ALPHANUMERIC_IMEI_CHECK','True','CDR');
insert ignore into app.sys_param ( tag , value , feature_name) values ('CDR_NULL_IMEI_REPLACE_PATTERN', '9999999999999999','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('SEATEL_ST_PGW_FILE_PATTERN','PGW_CDR-7-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('METFONE_MF_MSC15_FILE_PATTERN','HW_MSC15-9-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('METFONE_MF_MSC09_FILE_PATTERN','HW_MSC09-9-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('METFONE_MF_MSC10_FILE_PATTERN','HW_MSC10-9-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('METFONE_MF_MSC11_FILE_PATTERN','HW_MSC11-9-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('METFONE_MF_MSC14_FILE_PATTERN','HW_MSC14-9-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('METFONE_MF_MSC16_FILE_PATTERN','HW_MSC16-9-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('METFONE_MF_SGSN_FILE_PATTERN' , 'VTC-12-8,R9-8-8,CG-19-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('CELLCARD_CC_GGSN_FILE_PATTERN','HCG1_LTE-16-6','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('CELLCARD_CC_MSC02_FILE_PATTERN ','HWCS-4-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('CELLCARD_CC_MSC03_FILE_PATTERN ','HWCS-4-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('CELLCARD_CC_ZMSC71_FILE_PATTERN','ZMSC71-7-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('CELLCARD_CC_ZMSC72_FILE_PATTERN','ZMSC72-7-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('CELLCARD_CC_ZMSC73_FILE_PATTERN','ZMSC73-7-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('SMART_SM_IMS01_FILE_PATTERN','TKKvIMSAP-10-8,HQvIMSAP-9-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('SMART_SM_MSC01_FILE_PATTERN', 'BTKK-4-8,BTKKAP2-7-8,BTKKAP3-7-8,BTKKAP4-7-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('SMART_SM_MSC02_FILE_PATTERN','MSC02-8-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('SMART_SM_SCDR_FILE_PATTERN','TKK_AP-14-8,HQ_AP-13-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('SMART_SM_SGW_FILE_PATTERN','TKK_AP-16-8,HQ_AP-15-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('SMART_SM_IMS02_FILE_PATTERN','TKKvIMSAP-10-8,HQvIMSAP-9-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('CELLCARD_CC_IMS_FILE_PATTERN','SSSCG-16-8,SSS_CG-22-8,SSSCG-21-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('CELLCARD_CC_ZPGW21_FILE_PATTERN','CG-21-8,VTC-14-8,R9-10-8,N1PNH01ZPGW21-14-8 ','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('CELLCARD_CC_ZPGW22_FILE_PATTERN','N1PNH01ZPGW22-14-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('CELLCARD_CC_ZPGW23_FILE_PATTERN','N1PNH01ZPGW23-14-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('CELLCARD_CC_ZPGW24_FILE_PATTERN','N1PNH01ZPGW24-14-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('METFONE_MF_SGW_FILE_PATTERN',' CG-21-8,VTC-14-8,R9-10-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('METFONE_MF_IMS_FILE_PATTERN', 'IMPT01CF2_-10-8,IMPT01_-7-8,IMPT01CF5_-10-8,IMPT01CF4_-10-8','CDR');
insert ignore into app.sys_param (tag , value, feature_name) values ('SMART_SM_PGW_FILE_PATTERN','TKK_AP-16-8,HQ_AP-15-8','CDR');

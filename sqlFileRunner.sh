...
query="update $appdbName.cdr_file_processed_detail  set status = 'Done' , sql_process_start_time= '$now1' , sql_process_end_time = '$now2' , total_query_sql = '$wordcnt'  , total_update_sql = '$totalUpdateCount' where FILE_NAME = '$realFileName' ;"
